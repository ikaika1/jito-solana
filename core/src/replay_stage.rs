...
pub(crate) mod tests {
    ...
    fn test_mark_slots_duplicate_confirmed() {
        ...
        let mostly_confirmed_slots = vec![(0, bank_hash_0)];
        ...
        let mostly_confirmed_slots = vec![(5, bank_hash_5)];
        ReplayStage::mark_slots_confirmed(
            &confirmed_slots,
            mostly_confirmed_slots,
            &blockstore,
        ...
        let mostly_confirmed_slots = vec![(5, bank_hash_5), (6, bank_hash_6)];
        ReplayStage::mark_slots_confirmed(
            &confirmed_slots,
            mostly_confirmed_slots,
            &blockstore,
        ...
        let mostly_confirmed_slots = vec![(6, Hash::new_unique())];
        ReplayStage::mark_slots_confirmed(
            &confirmed_slots,
            mostly_confirmed_slots,
            &blockstore,
